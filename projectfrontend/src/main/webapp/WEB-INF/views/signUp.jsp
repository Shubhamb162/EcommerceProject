...
<body>
	...
	<form:form method="post" modelAttribute="customer"
		action="signUpProcess" novalidate="true">
		<br>
		<br>
		<br>
				...
				<div class="col-sm-4">
					...
					<div class="form-group">
						...
						<form:input type="text" path="firstName" class="form-control"
							name="firstName" id="name" placeholder="Enter First Name"
							required="true" pattern="[a-zA-Z]{4,12}" />
					...
					<div class="form-group">
						...
						<form:input type="email" path="emailId" class="form-control"
							name="emailId" id="email" placeholder="Enter EmailId"
							required="true" />
					...
					<div class="form-group">
						...
						<form:input type="text" path="mobileNo" class="form-control"
							name="mobileNo" id="mobileNo" placeholder="Enter Mobile Number"
					...
					<div class="form-group">
						...
						<form:input type="password" class="form-control" name="password"
							id="password" path="password" placeholder="Enter password"
							required="true" pattern="[a-zA-Z.]{6,10}" />
