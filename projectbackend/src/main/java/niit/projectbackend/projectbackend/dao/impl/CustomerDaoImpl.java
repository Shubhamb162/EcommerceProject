...
@Repository("customerDao") // for doing all database related operation we have
...
public class CustomerDaoImpl implements CustomerDao {
	...
	public boolean addCustomer(Customer customer) {
		...
		// return false; we can write here also but logically we have to write
		// in Catch block
	}
	...
	public Customer getCustomer(String emailId) {
		return (Customer) sessionFactory.getCurrentSession().createQuery("from Customer where emailId=:email")
